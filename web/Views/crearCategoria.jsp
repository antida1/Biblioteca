...
<html>
    ...
    <body class="container">
        <form method="POST" action="../Servlets/Servlet_Cat" id="frmCrearCat" class="form-group">
            <header>            
                <div class="row">
                    <img src="../images/categorias.jpg" class="img-responsive left-block" alt="CATEGORíAS" style="text-align:left; margin: 0px; display: block;">
                    <h1 style="margin: 100px;">CREAR CATEGORÍAS</h1>
                </div>
            </header>
            <br />
            <br /> 
		...
		<section> 
			...
			<div class="row">
				...
				<div class="input-group">
					...
					<label class="label control-label" >Nombre de la Categoría:</label>
                                    </span> 
                                    <input type="text" name="txtNombre" id="txtNombre" class="textBox form-control col-md-4" placeholder="Categoría" required="true">
				</div>
                            </div>
                        </div>
                        <br />
				...
				<div class="input-group" >
                                    <input type="button" class="button btn btn-success" name="btnCrear" value="CREAR" id="btnCrear" title="CREAR CATEGORÍA"> 
